...
namespace Helion.Bsp.Node
{
    ...
    public class BspNode
    {
        ...
        {
            Debug.Assert(edges.Count >= 3, "Cannot create a child that is not at least a triangle");
            Debug.Assert(EdgesAreHeadToTail(edges), "BSP node subsector edges are not closed");
