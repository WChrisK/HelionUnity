...
namespace Helion.Bsp.States.Split
{
    public class SplitCalculator
    {
        ...
        private BitArray seenCollinear = new BitArray(0);
        ...
        {
            Debug.Assert(segments.Count > 0, "Cannot do BSP split calculations on an empty segment list");
        ...
        {
            return distance.ApproxZero(epsilon) || distance.Approx(1.0, epsilon);
        }
