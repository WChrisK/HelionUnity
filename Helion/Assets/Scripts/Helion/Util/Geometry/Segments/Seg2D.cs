...
namespace Helion.Util.Geometry.Segments
{
    ...
    public struct Seg2D
    {
        ...
        /// </summary>
        public Vec2D DeltaInverse => new Vec2D(1.0f / Delta.X, 1.0f / Delta.Y);

        /// <summary>
        /// The bounding box of this segment.
        /// </summary>
        public Box2D Box => MakeBox(Start, End);
        ...
        public Seg2D(double startX, double startY, double endX, double endY) :
        ...
        public static implicit operator Seg2D(ValueTuple<Vec2D, Vec2D> pair) => new Seg2D(pair.Item1, pair.Item2);
        ...
        public static Rotation GetRotation(Vec2D first, Vec2D second, Vec2D third, double epsilon = 0.000001)
        {
            return new Seg2D(first, second).ToSide(third, epsilon);
        }
        ...
        public bool Overlaps(Seg2D seg)
        {
        ...
        /// <summary>
        /// Same as <see cref="SameDirection(Seg2D)"/> but uses a delta to
        /// check.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// See <see cref="IntersectionAsLine(Seg2D, out double)"/> for one
        /// and <see cref="IntersectionAsLine(Seg2D, out double, out double)"/>
